...
func main() {
	...
	r.HandleFunc("/vinyl", limitHandler(createVinylHandler)).Methods("POST")
	r.HandleFunc("/vinyl/{id}", limitHandler(getVinylHandler)).Methods("GET")
	r.HandleFunc("/vinyl/{id}", limitHandler(updateVinylHandler)).Methods("PUT")
	r.HandleFunc("/vinyl/{id}", limitHandler(deleteVinylHandler)).Methods("DELETE")
